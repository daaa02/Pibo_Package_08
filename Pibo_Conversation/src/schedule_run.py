...
from Pibo_Package_08.Pibo_Conversation.src.drive_upload import drive_upload
...
class RunSchedule():
    ...
    def __init__(self):
        self.path = '/home/pi/Pibo_Package_08'
        self.completion = int
        self.act = ''
    ...
    def day(self):
        ...
        if 1 <= self.completion <= 8:
            fix = {1:'Pibo_Conversation/src/Etiquette/03_cough.py', 2:'Pibo_Play/src/Com/com_4.py',
        ...
        try:
            ...
            logfile = f'(P08)_{datetime.now().strftime("%m%d_%H%M")}.txt'   #('P<PACKAGE_NUMBER>_DATE.txt')   
